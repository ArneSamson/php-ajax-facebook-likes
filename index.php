...
<body>
	...
	<article>
		...
		<div>
			<a href="#" data-id="<?php echo $post->id; ?>" class="like">Like</a> <span class='likes' id="likes<?php echo $post->id; ?>"><?php echo $post->getLikes(); ?></span> people like this 
		</div>
	</article>
	<?php endforeach; ?>
	...
	<script>
		...
		for (let i = 0; i < links.length; i++) {
			links[i].addEventListener("click", function(e){
				...
				//fetch (POST) to akax/like.php, use formdata
